...
class Config(object):
  ...
  BOT_OWNER = int(os.environ.get("BOT_OWNER", "6040965491"))
  DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://vikesas792:vikesas792@cluster0.daeu31u.mongodb.net/?retryWrites=true&w=majority")
